...
BS Software Engineering \textit{GPA: \bf{3.73}} 
...
\vspace{-2mm}
\begin{itemize} \itemsep -1pt
	\item \textbf{Doubled the throughput} of Holsum's assembly line by replacing outdated PLC panels with newer ones containing a wider arsenal of commands.
	\item Collaborated with electrical engineers to develop the PLC interface.
\end{itemize}
